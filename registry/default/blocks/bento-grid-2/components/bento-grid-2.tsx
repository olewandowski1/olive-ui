...
export default function BentoGrid2({
  ...
  cards = [
    ...
    },
    {
      ...
      description:
        'Unlock powerful tools and capabilities to take your projects to the next level. Amplify your workflow with our advanced features that are designed to enhance productivity and creativity.',
      icon: Sparkles,
    ...
    },
    {
      ...
      description:
        'End-to-end solutions designed to meet all your business requirements. From initial setup to ongoing support, our comprehensive solutions ensure you have everything you need to succeed.',
      icon: Lightbulb,
      className: 'md:col-span-1',
      imageUrl: '',
    },
    {
      ...
      title: 'Customization',
      description:
        'Tailor the platform to your specific needs with extensive customization options. Enhance your user experience by adjusting settings and features to fit your workflow perfectly.',
      icon: Palette,
      className: 'md:col-span-1',
      imageUrl: '',
    },
            ...
            {cards.map(
              ({ id, title, description, icon: Icon, className, imageUrl }) => (
                ...
                >
                  ...
                  <CardFooter className='relative h-64 p-0 mt-auto overflow-hidden border rounded-lg'>
                    {imageUrl ? (
                      <>
                        <img
                          src={imageUrl}
